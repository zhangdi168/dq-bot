...
# COPY 源路径 目标路径
COPY . $GOPATH/src/github.com/zhangdi168/dq-bot

# RUN 执行 go build .
RUN cd $GOPATH/src/github.com/zhangdi168/dq-bot && go build .
...
COPY --from=builder /opt/repo/src/github.com/zhangdi168/dq-bot /opt
